...
x1 = spark.read.text('/home/hadoop/Desktop/techGoogle/*')
x1 = x1.withColumn("Category",lit("techGoogle"))

x1.show()
x1data= x1.select([column for column in x1.columns])
...
predictions = model.transform(x1data)
